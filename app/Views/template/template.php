...
<html lang="en">
    <head>
        ...
        <!-- CSS files -->
        <link rel="stylesheet" type="text/css" href="<? echo WEBROOT;?>bootstrap-5.3/css/bootstrap.min.css">
        ...
        <script type="text/javascript" src="<? echo WEBROOT;?>bootstrap-5.3/js/bootstrap.min.js"></script>
