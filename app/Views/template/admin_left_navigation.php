    ...
    <div class="topbar container-fluid">
        <div class="d-flex align-items-center gap-lg-2 gap-1">
            ...
            <span style="width: 90px;">
                <a href="<?= WEBROOT ?>" title="Home"><img src="<?= WEBROOT ?>assets/images/logo.png" alt="logo" class="img-fluid"></a>
            </span>
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    ...
                    <span class="account-user-avatar">
                        <img src="<?= WEBROOT ?>assets/images/profile/profile_img.png" alt="profile-image" class="rounded-circle" width="18">
                    </span>
                </a>
    ...
    <div class="h-100 show" id="leftside-menu-container" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                <a href="<?= WEBROOT ?>employee" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="modules">
                    <ul class="side-nav-second-level">
                        <li><a href="<?= WEBROOT ?>district">Districts</a></li>
                        <li><a href="<?= WEBROOT ?>state">States</a></li>
                        <li><a href="<?= WEBROOT ?>country">Countries</a></li>
                        <li><a href="<?= WEBROOT ?>documenttypes">Document Types</a></li>
                        <li><a href="<?= WEBROOT ?>familyRelation">Family Relation</a></li>
                        <li><a href="<?= WEBROOT ?>educationalQualification">Educational Qualification</a></li>
                    </ul>
                </div>
            </li>
            <li class="side-nav-item">
