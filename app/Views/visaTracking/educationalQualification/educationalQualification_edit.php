 ...
 */
$id_val = isset($educationalQualification['id']) ? $educationalQualification['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($educationalQualification['name']) ? $educationalQualification['name'] : set_value('name');
?>

<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="edit_qualification" onsubmit="return false">
			<?= csrf_field(); ?>
			<input type="hidden" name="id" value="<?= $id_val; ?>">
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit Qualification</h5>
            ...
            <div class="modal-footer">
            	<button type="submit" onclick="updateQualification()" class="btn btn-success btn-sm"><i class="bi bi-check-square"></i>&nbsp;Update</button>
