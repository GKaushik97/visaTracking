 ...
 * Edit Relation
 */
$id_val = isset($familyRelation['id']) ? $familyRelation['id'] : (isset($_POST['id']) ? $_POST['id'] : '');
$name_val = isset($familyRelation['name']) ? $familyRelation['name'] : set_value('name');
?>

<div class="modal-dialog">
	<div class="modal-content">
		<form method="post" id="edit_relation" onsubmit="return false">
			<?= csrf_field(); ?>
			<input type="hidden" name="id" value="<?= $id_val; ?>">
			<div class="modal-header">
				<h5 class="modal-title fs-5">Edit Relation</h5>
            ...
            <div class="modal-footer">
            	<button type="submit" onclick="updateRelation()" class="btn btn-success btn-sm"><i class="bi bi-check-square"></i>&nbsp;Update</button>
