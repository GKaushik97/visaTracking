<div class="modal-dialog">
    <div class="modal-content">
        <form method="post" id="add_relation" onsubmit="return false">
            <?= csrf_field(); ?>
            <div class="modal-header">
                <h5 class="modal-title fs-5">Add Family Relation</h5>
            ...
            <div class="modal-footer">
                <button type="submit" onclick="insertRelation()" class="btn btn-success btn-sm"><i class="bi bi-plus"></i>&nbsp;Add</button>
